...
function App() {
  ...
  const editMode = (window as any).editMode;
  console.log((window as any).editMode);
  ...
  const widget = stateObject ? (
    <header className="App-header">
      ...
      <h1>Nx Widget React Starter</h1>
      <h2>{editMode ? "Edit Mode" : "Widget Mode"}</h2>
      <p>
        <h2>Shared state from cloud portal: {count}</h2>
